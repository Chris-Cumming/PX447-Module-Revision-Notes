...
The original lecture notes for this module are heavily based off the Nielsen and Chuang recommended textbook. The same is true of these revision notes. I would definitely recommend the textbook if there is anything unclear at any point in either these revision notes or the original lecture notes. Unfortunately however the section on solving linear systems of equations is not present in the textbook. %John Preskill online lecture notes could be useful. Kept overall organisation the same as original lecture notes but with some additions. Tried to add extra steps where original steps may be unclear.
%\clearpage
%----------------------------------------------------------------------------------------
%	ACKNOWLEDGEMENTS
%----------------------------------------------------------------------------------------
